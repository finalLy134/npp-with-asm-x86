...
6. עקוב אחרי **הפעלה** על מנת לגרום להכל לעבוד.
 ...
 3. לחץ על ה **...** לעיון ותגיע לתיקיית ה `C:\TASM\BIN` ועקוב אחרי **הפעלת סקריפט הידור וריצה יחד** ו- **הפעלת סקריפט הידור ללא ריצה**

#### הפעלת סקריפט הידור וריצה יחד
4. בחר ב `C:\TASM\BIN\COMPILE_AND_RUN.BAT`
...
4. בחר ב `C:\TASM\BIN\COMPILE_ONLY.BAT`
5. זה יוסיף את מיקום הקובץ לפקודת הריצה, צור רווח ותלחץ **+** בצד ימין לפקודה
6. בחר `FULL_CURRENT_PATH`
